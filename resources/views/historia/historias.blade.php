...
<div x-data="modalEdit()">
                    ...
                    @foreach ($historias as $historia)
                        <tr class="border-t hover:bg-gray-50">
                            ...
                            <td class="px-4 py-2 flex space-x-2">
                                ...
                                <button onclick="mostrarDetalles({{ $historia->id_historia }})" class="text-blue-600 hover:text-blue-800">
                                ...
                                {{-- Eliminar --}}
                                <button onclick="confirmarEliminar({{ $historia->id_historia }}, '{{ $historia->titulo }}')" class="text-red-600 hover:text-red-800">
    ...
    <div
        ...
        <div class="bg-white w-full max-w-md p-6 rounded-lg shadow-lg relative">
            ...
            <h2 class="text-lg font-bold text-black-700 mb-4"><i class="fas fa-user-edit mr-2"></i>Editar Historia</h2>
            ...
            <form :action="'/historias/' + form.id" method="POST" @submit="show = false">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="titulo"  x-model="form.titulo"class="w-full bg-gray-200 border-3 border-red-100 rounded px-3 py-2">
                </div>

                <div class="mb-4">
                    <label class="block font-semibold">Descripción</label>
                    <textarea name="descripcion" x-model="form.descripcion"class="w-full bg-gray-200 border-3 border-red-100 rounded px-3 py-2"></textarea>
                </div>

                <div class="mb-4">
                    <label class="block font-semibold">Fuentes</label>
                    <input type="text" name="fuentes" x-model="form.fuentes"class="w-full bg-gray-200 border-3 border-red-100 rounded px-3 py-2">
                </div>

                <div class="mb-4">
                    <label class="block font-semibold">Puntuación</label>
                    <input type="number" name="puntuacion" x-model="form.puntuacion"class="w-full bg-gray-200 border-3 border-red-100 rounded px-3 py-2">
                </div>
                ...
                <div class="flex justify-end gap-2">
                    ...
                    <button type="submit" class="bg-pink-600 text-white px-4 py-2 rounded hover:bg-pink-700">Editar historia</button>
        ...
        <div class="flex items-center justify-center min-h-screen">
            <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6">
                <div class="flex justify-between items-center border-b pb-2 mb-2">
                    <h2 class="text-lg font-bold text-black-700 mb-4"><i class="fas fa-info-circle"></i> Detalles de la historia</h2>
        ...
        <div class="flex items-center justify-center min-h-screen">
            <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6">
                <div class="flex justify-between items-center border-b pb-2 mb-4">
                    <h2 class="text-lg font-bold text-black-600"><i class="fas fa-trash-alt"></i> Eliminar Historia</h2>
                    <button onclick="cerrarModalEliminar()" class="text-gray-600 hover:text-black-600 text-lg">&times;</button>
                </div> 

                <p class="text-gray-800 mb-4">¿Estás seguro que deseas eliminar la historia <span id="tituloCulturaEliminar" class="font-semibold text-black-600"></span>?</p>
        ...
        <div class="bg-white w-full max-w-2xl p-6 rounded-lg shadow-lg overflow-y-auto max-h-[90vh] relative">
            ...
            <form action="{{ route('historias.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="titulo" value="{{ old('titulo') }}" class="w-full border border-gray-300 rounded px-3 py-2" required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="fuentes" value="{{ old('fuentes') }}" class="w-full border border-gray-300 rounded px-3 py-2" required>
                </div>

                <div class="mb-4">
                    <label class="block font-semibold mb-1">Puntuación</label>
                    <input type="text" name="puntuacion" value="{{ old('puntuacion') }}" class="w-full border border-gray-300 rounded px-3 py-2" required>
                </div>
